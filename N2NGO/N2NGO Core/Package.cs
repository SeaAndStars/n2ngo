...
public struct Package
{
    ...
    {
        Package package = new() { Header = package_data[0] };
    ...
    public class IO_Tool
    {
        ...
        public bool Send(System.Net.Sockets.TcpClient client, Package package, bool timeOut = false)
        {
        //start:
            latestEx = null;
            if (timeOut)
        ...
        public Package? Receive(System.Net.Sockets.TcpClient client, byte? defH = null, bool timeOut = false)
        {
        start:
            latestEx = null;
            if (timeOut)
