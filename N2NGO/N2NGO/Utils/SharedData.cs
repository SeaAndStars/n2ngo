...
public static class SharedData
{
    ...
    public static class CurrentApp
    {
        ...
        public static Views.MainWindow MainWindow => (Views.MainWindow)App.Current.MainWindow;
        public static N2NGOCore.EasyConfig Config { get; } = new(Path.Combine(N2NGOCore.Globals.N2NGO_N2NGO_AppData_Path, "UserData/config.ini"));
