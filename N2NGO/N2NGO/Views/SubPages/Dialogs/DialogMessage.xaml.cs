...
public partial class DialogMessage : Page
{
    ...
    public DialogMessage(List<Action<object>>? ActsRet = null)
    {
        ...
        CustomUI.InitButtons(CustomUIHelpers.FindVisualChildren<Button>((Grid)Content));
        CustomUI.InitCards(CustomUIHelpers.FindVisualChildren<Label>((Grid)Content));
            ...
            case DialogType.OK:
                {
                    ...
                    CustomUI.InitButton(_c.ButtonOK);
            ...
            case DialogType.YesNo:
                {
                    ...
                    CustomUI.InitButtons(new Button[] { _c.ButtonYes, _c.ButtonNo });
            ...
            case DialogType.InputConfirm:
                {
                    ...
                    CustomUI.InitButtons(new Button[] { _c.ButtonOK });
                    _c.ButtonOK.Click += (_, __) =>
                    {
                        ButtonClicked();
                    };
            ...
            case DialogType.PickBrushDone:
                {
                    ...
                    CustomUI.InitButtons(new Button[] { _c.ButtonDone });
